$(() => {
    ...
    */
    ...
    const onReorderSelectChange = (e) => {
        ...
        if (!entryRow.previousElementSibling && direction === 'up') {
            firstOrLast = true;
        } else if (!entryRow.nextElementSibling && direction === 'down') {
            firstOrLast = true;
        }
        $.ajax({
            type: 'POST',
